...
module.exports = async options => {
  ...
  writeFileSync('./maiidrit.json', JSON.stringify(payload, null, 2))
  try {
    ...
    logger('error', ['send-mail', 'failed to send mail', 'to', payload.to, 'cc', cc, 'bcc', bcc, error.response?.data || error.stack || error.toString()])
    return null
  }
}
